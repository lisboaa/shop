...
const ProductItem = ({product}: ProductItemProps) => {
    return ( 
        <div className="flex flex-col gap-4">
            ...
            <div>
                <p className="overflow-hidden text-ellipsis whitespace-nowrap w-full text-sm ">{product.name}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
                    {product.discountPercentage > 0 ? (
                        ...
                        <p className="overflow-hidden text-ellipsis whitespace-nowrap text-sm font-semibold">R$ {product.totalPrice.toFixed(2)}</p>
                    )
                    }
            </div>
